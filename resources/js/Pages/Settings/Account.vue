      ...
      <div class="py-10">
        ...
        <div class="mt-4">
          <form @submit.prevent="confirmDeleteAccount()">
            ...
            <button
              type="submit"
              class="text-white font-bold bg-red-500 hover:bg-red-600 w-full py-3 px-4 rounded focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
            >
              Delete Account
            </button>
          </form>
